      ...
      <ScrollView showsVerticalScrollIndicator={false} >
        ...
        <ScrollView
          ...
          {mediaGallery.map((media, index) => (
            <TouchableOpacity
              key={`media_thumbnail_${media.id}_${index}`}
        ...
        <CustomText style={styles?.description}>
          Join me for a 30-day squat challenge! Follow my daily routine and
        ...
        <View style={styles?.rowContainer}>
          <IconWithText
            image={Images?.clock}
            text="12 Mins"
            textStyle={{fontSize: moderateScale(14, 0.3)}}
          />
          <IconWithText
            image={Images?.fire}
            text="120 Kcal"
        ...
        {/* Steps Section */}
        <CustomText
          style={[styles?.heading, {marginTop: moderateScale(24, 0.3)}]}>
          Steps
        </CustomText>
